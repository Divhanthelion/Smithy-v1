...
description: Build and sharpen a project's domain model. Use when pinning terminology, recording an ADR, or when another Skill needs the glossary.
argument-hint: "Optional term or decision under discussion"
include: CONTEXT-FORMAT.md, ADR-FORMAT.md
tools: [read, write, ls, glob, grep, edit, symbol, explore]
---
